  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto', position: 'relative' }}>
      ...
      <div className="glass-panel" style={{ display: 'flex', gap: '16px', marginBottom: '24px', padding: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        <button className="btn-danger" style={{ transform: 'skewX(-12deg)', marginLeft: 'auto' }} onClick={() => { if (!selectedTrack) { alert('Wybierz trasę, aby zresetować wyniki.'); return; } if (window.confirm('Czy na pewno chcesz zresetować wszystkie wyniki dla tej trasy? (Tej akcji nie można cofnąć)')) { clearBoard({ trackId: selectedTrack as any }); } }}>Reset Wyników dla wybranej trasy</button>
      </div>
